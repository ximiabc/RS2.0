...
<html>
  <head>
	...
	<body>
		<div id="primaryOut" class="container">
			<div class="row">
				<div class="col-xs-offset-1 col-xs-10">
					<div class="btn-group btn-group-justified" role="group">
						...
						<div class="btn-group" role="group">
<<<<<<< HEAD
							<a href="excelOut" id="rs-down" type="button" class="btn btn-default btn-info btn-lg">
=======
							<a href="excelOut" id="rs-down" class="btn btn-default btn-info btn-lg">
