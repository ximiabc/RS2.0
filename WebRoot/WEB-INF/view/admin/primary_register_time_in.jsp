  ...
  <head>
	...
	<body>
		<div style="padding: 100px 50px 0;">
			<form class="form-horizontal" action="admin_date_primaryInUpdate" method="post">
				<div class="col-xs-offset-1 col-xs-10">
					<div class="panel panel-default">
						<div class="panel-heading">小学辖区内生源报名日期</div>
						<div class="panel-body form-group">
			                <label for="startTime" class="col-xs-offset-2 control-label">开始报名日期<small class="rs-radioMsg"></small>：</label>
			                ...
			                <label for="endTime" class="col-xs-offset-2 control-label">结束报名日期<small class="rs-radioMsg"></small>：</label>
